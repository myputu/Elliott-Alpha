...
class Forwardtester:
    ...
    def run_forwardtest(self, analyzer, strategy):
        """Run the forwardtest using the analyzer and strategy."""
        print("Starting forwardtest...")
        ...
        print(f"Forwardtest complete. Final balance: ${self.current_balance:.2f}")
...
if __name__ == "__main__":
    ...
    db = OHLCDatabase()
    forwardtest_df = db.get_ohlc_data("XAUUSD")
    
    # Initialize components
    analyzer = ElliottWaveAnalyzer(forwardtest_df)
    strategy = ElliottWaveTradingStrategy(analyzer)
    forwardtester = Forwardtester(forwardtest_df)
    
    # Run forwardtest
    performance = forwardtester.run_forwardtest(analyzer, strategy)
